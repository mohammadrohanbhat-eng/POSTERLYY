...
exports.handler = async (event) => {
  try {
    ...
    // This is your verified Brevo sender address.
    const senderEmail = process.env.BREVO_SENDER_EMAIL || "aurevixtechnologies@gmail.com";
    ...
    if (brevoApiKey) {
      ...
      try {
        await sendBrevoEmail({
          ...
          senderEmail,
          senderName,
          toEmail: "aurevixtechnologies@gmail.com",
